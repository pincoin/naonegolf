...
## hostname
```
# hostnamectl set-hostname naonegolf
# reboot
```
...
$ pyenv virtualenv -p python3.7 3.7.5 django
...
$ sudo mysql
> CREATE DATABASE naonegolf DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
> CREATE USER naonegolf@localhost IDENTIFIED BY 'pass';
> GRANT ALL PRIVILEGES ON naonegolf.* TO naonegolf@localhost;
> FLUSH PRIVILEGES;
```
...
$ sudo mkdir -p /var/www/naonegolf
$ sudo chown was /var/www/naonegolf/
```

```
$ sudo su - was
$ cd /var/www/naonegolf
$ git clone git@github.com:pincoin/naonegolf.git repo
$ mkdir run ssl logs repo/media
$ exit
```

```
$ sudo chown was:www-data /var/www/naonegolf/run/
```
